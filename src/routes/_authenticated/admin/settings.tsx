    ...
    <PageBody>
      <div className="max-w-2xl space-y-6 rounded-xl border border-border/60 bg-card p-6">
        <div className="grid grid-cols-2 gap-4">
          <div><Label>Platform name</Label><Input value={form.platform_name} onChange={(e) => setForm({ ...form, platform_name: e.target.value })} /></div>
        ...
        <div>
          ...
          <Input type="number" min={0} max={180} value={form.commission_hold_days} onChange={(e) => setForm({ ...form, commission_hold_days: Number(e.target.value) })} />
