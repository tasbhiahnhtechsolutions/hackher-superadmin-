    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border/50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-elegant hover:opacity-90"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 pt-20 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
          Manage affiliates, promo codes, commissions, and Stripe subscriptions across a multi-tier
          hierarchy — with enterprise-grade security baked in.
        </p>
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-medium text-primary-foreground shadow-elegant hover:opacity-90"
          >
            Sign in to your portal <ArrowRight className="h-4 w-4" />
          </Link>
          <Link
            to="/pricing"
            className="inline-flex items-center rounded-md border border-border bg-card/50 px-6 py-3 text-sm font-medium hover:bg-accent glass"
          >
            View pricing
          </Link>
        </div>
        ...
        <div className="mx-auto mt-20 grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-4">
          {[
            ...
            <div
              key={f.title}
              className="rounded-xl border border-border/60 bg-card p-5 text-left shadow-card"
            >
